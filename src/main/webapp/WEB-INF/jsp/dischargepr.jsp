...
function addcname(getval){
	...
	var strSplit = myname.split('=');
	  ...
	  // document.getElementById("dissum").value = dissum;
	   ...
	   document.getElementById("investigation").innerHTML = strSplit[11];
...
function disp(){
	...
	document.getElementById("investigation").style.height = "auto";
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" >Print Discharge Summary</a>
    </div>
...
<font size="5">Discharge Summary</font><span class="button2"><i class="" style="color:#ff9900;margin: 4px 8px;"></i>
...
<div class="form-group row" >
 ...
 <div class="form-group row" >
  ...
  <div class="form-group">
      ...
      <option data-subtext="${p1.fileno},${p1.admitno}" value="${p1.pname}" data-value="${p1.pid}=${p1.pname}=${p1.dname}=${p1.docid}=${p1.admdate}=${p1.disdate}=${p1.admitno}=${p1.fileno}=${p1.wardno}=${p1.age}=${p1.gender}=${p1.investigation}">${p1.pname}</option>
        </c:forEach>
      </select>
...
<div class="form-group row" >
   ...
   <div class="col-xs-1"></div>
    <div class="col-xs-8">
  <p><h4>Summary</h4></p>   
<div class="textarea" id="investigation" style="white-space: pre-wrap;word-wrap: break-word;page-break-after: auto;" contenteditable="false">
