...
//		var time ="time"+i;
	 //   var ora ="oraltype"+i;
		  ...
		  newCell.innerHTML="<tr><td><input type='hidden' name='aid1' form='forma' id='aid1'  value= "+$.now()+"><input  form ='forma' style='width:100%;  border:groove;' class= 'form-control input-sm' value = '"+m+"' type='text' id = 'time' readonly='readonly' name= 'time' required  ></td></tr>";
		  ...
		  newCell = rowsAdd.insertCell();
		  newCell.innerHTML="<tr><td><input form ='forma' value = 'NA' class= 'form-control input-sm'  type='text'  id = 'discontinue' name= 'discontinue' ></td></tr>";
		  newCell.style.width='150px';
		  newCell.style.border='groove';
	         ...
	         async: false,
	           ...
	           success: function(response){
	 	   	...
	 	   	var rowsAdd = tableRef.insertRow(tableRef.rows.length); 
	 			...
	 			var newCell = rowsAdd.insertCell();
	 			  newCell.innerHTML="<tr><td><input type='hidden' name='aid1' form='forma' id='aid1'  value= "+datec.aid1+"><input readonly='readonly'  form ='forma' style='width:100%;  border:groove;' class= 'form-control input-sm' value = '"+datec.time+"' readonly='readonly' type='text' id = 'time' name= 'time'  ></td></tr>";
	 			  newCell.style.width ='140px';
	 			  newCell.style.border='groove'
       ...
       function doAjaxPost2(drug,date,user2b,user2a) {
   	 ...
   	 var m = moment().format("DD-MM-YYYY h:mm a");
    	   ...
    	   $.ajax({
	           ...
	           url: "/HMS/opdchart3/"+fileno+"/"+decodeURI(drug)+"/"+date+"",
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" >Post Medical Examination Procedures</a>
    </div>
...
<font size="5">Post Medical Examination Procedures</font><span class="button2"><i class="" style="color:#ff9900;margin: 4px 8px;"></i>
		</span>
	</h1>
...
<div class="container">
 ...
 <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <form id="forma" name="forma" action="/HMS/saveOpd.html" method="post"></form>
      <form id="formbc" name="formbc" action="/HMS/saveOpd.html" method="post"></form>
  ...
  <div class="form-group">
      ...
      <c:forEach var="p"  items="${model.list3}">
        <option value="${p.pname}" data-subtext="${p.fileno}" data-value="${p.pname},${p.pid},${p.appointment},${p.time},${p.fileno},${p.docid},${p.dname}">${p.pname}</option>
        </c:forEach>
      </select>
...
<div class="form-group">
  ...
  <table class="table table-bordered " data-click-to-select="true" data-single-select="true" style="width: 1200px; align: center;" id="myTable1">
    ...
    <tbody class="tbody1">
       ...
       <tr id="hiderow">
		    <td><i class='fa fa-plus' style='font-size:20px; color : #ff9900;'  onclick="return display('<c:out value="${username}" />','<c:out value="${pageContext.request.userPrincipal.name}" />')"></i></a><a href="#" class='button3'  style='color : #ff9900;'  onclick="cleartab1()"><b>Clear Table</b></a><a href="#" class='button2' id="bouton-contact" style='color : #ff9900;'  onclick="return doAjaxPostSave('forma')"><b>Save</b></a></td>
		  </tr>
