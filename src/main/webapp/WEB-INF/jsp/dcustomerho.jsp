...
function datasuccess(data){
	...
	if(data != "null"){
		...
		alert(data)
window.location = "/HMS/dcustomerho.html";
	}
}
</script>
<script>
...
<nav class="navbar navbar-default">
  ...
  <div id="form2" >  
     ...
     <h1><button type="button" id="refresh" class="btn btn-warning button1" onclick="location.href='/HMS/dcustomerho.html';">
