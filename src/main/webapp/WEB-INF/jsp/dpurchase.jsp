...
function datasuccess(data){
	...
	if(data != "null"){
		...
		alert(data)
window.location = "/HMS/dpurchaseho.html";
	}
}
...
function setUrl(myurl){
	...
	$('#vp').attr("href","/HMS/dprpur?allo="+url+"");
}
...
var cps;
       function doAjaxPost2(batch,name) {
    	   ...
    	   $.ajax({
	           ...
	           url: "/HMS/dgetBatdet?location="+encodeURIComponent(batch)+"&&location1="+encodeURIComponent(name)+"",
	          data: "0",
    ...
    <a class="navbar-brand" >Purchase Entry </a>
     ...
     <ul class="nav navbar-nav">
      ...
      <li class="dropdown" id="dr1">
        ...
        <li class="pra"><a href="/HMS/manufactureho.html">Manufacturer Master</a></li>
       <li class="pra"><a href="/HMS/supplierho.html">Supplier Master</a></li>
       <li class="pra"><a href="/HMS/customerho.html">Customer Master</a></li>
       <li><a href="/HMS/productho.html">Product  Master</a></li>
       </ul>
     
      <li class="pra"><a href="/HMS/orderho.html">Order & Reorder</a></li>
        <li class="pra"><a href="/HMS/purchaseho.html">Purchase Entry</a></li>
