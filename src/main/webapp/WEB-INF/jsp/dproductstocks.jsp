 ...
 function checkhome2(user){
 	cuser = user;
 	 ...
 	 if(user == "[ROLE_DISPSALESMANAGER]"){
		...
		$('#fh').text('Dispensary Product Stocks and Pricing')
		$('.navbar-brand').text('Dispensary Product Stocks and Pricing')
 	}
...
function datasuccess(data){
	...
	if(data != "null"){
		...
		alert(data)
window.location = "/HMS/dstopriceho.html";
	}
}
...
<nav class="navbar navbar-default">
     ...
     <ul class="nav navbar-nav">
      ...
      <li class="dropdown" id="dr1">
       ...
       <li><a href="/HMS/productho.html">Product  Master</a></li>
        ...
        <li class="pra" id="or"><a href="/HMS/orderho.html">Order & Reorder</a></li>
        <li class="pra" id="pe"><a href="/HMS/purchaseho.html">Purchase Entry</a></li>
  ...
  <div id="form2a" >  
     ...
     <h1>
     <font size="5" id="fh">Product Stocks and Pricing </font><span class="button2"></span><i class="" style="color:#ff9900;margin: 4px 8px;"></i>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
      <div id="col3">
       <form id = "form2" method="post" action ="dpssaveho.html"></form>
