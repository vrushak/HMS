...
function datasuccess(data){
	...
	if(data != "null"){
		...
		alert(data)
window.location = "/HMS/dsaleho.html";
	}
}
...
if(supplier == "Select"){
   ...
   var url = "/HMS/dsalespdf1?invoice="+supplier+"" ;
...
<div id="main">
 ...
 <form id ="saveSales" action="dsaleho2.html" method="post">
 </form>
