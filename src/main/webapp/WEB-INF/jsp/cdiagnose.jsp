...
function updchname(val,div,tab,value){
	...
	if (head == null || head == " " || head.length == 0) {
  	    ...
  	    var uri = "/HMS/cupdchname?cid="+cid+"&&header="+head+"";
		var data = "0";
...
if(cid == undefined || cid == " " || cid.length == 0){
	...
	if (head == null || head == " " || head.length == "0") {
  	    ...
  	    var uri = "/HMS/cupdtabs?tabid="+cid+"&&tabvalue="+head+"";
		var data = "0";
...
function datasuccess(data){
	...
	if(data != "null"){
		...
		alert(data)
window.location = "/HMS/cdiagnose/user";
	}
}
/*
...
<nav class="navbar navbar-default">
 ...
 <div id ="form2">
  ...
  <font size="5" id="cd"> Dental Diagnosis </font><button class="btn btn-warning btn-sm button2" id="preview" class="form-control input-sm" onclick="preview()">ADD</button>
